...
This shows that vectors are better for memory optimization for cases like this. ChatGpt build the input file and recommended it be 30000 entires, as this is better for testing
